...
class CMBLensRec(object):
   ...
   def SaveAll(self):
      ...
      tStart = time()
      data[:,1] = np.array(map(self.A_TT, self.L))
      ...
      tStart = time()
      data[:,2] = np.array(map(self.A_TE, self.L))
      np.savetxt(self.path, data)
      tStop = time()
      print "took", (tStop-tStart)/60., "min"
      print "Computing A_TB"
      tStart = time()
      data[:,3] = np.array(map(self.A_TB, self.L))
      np.savetxt(self.path, data)
      tStop = time()
      print "took", (tStop-tStart)/60., "min"
      print "Computing A_EE"
      tStart = time()
      data[:,4] = np.array(map(self.A_EE, self.L))
      np.savetxt(self.path, data)
      tStop = time()
      print "took", (tStop-tStart)/60., "min"
      print "Computing A_EB"
      tStart = time()
      data[:,5] = np.array(map(self.A_EB, self.L))
      np.savetxt(self.path, data)
      tStop = time()
      print "took", (tStop-tStart)/60., "min"
      ...
      tStart = time()
      data[:,6] = np.array(map(self.N_TT_TE, self.L))
      ...
      tStart = time()
      data[:,7] = np.array(map(self.N_TT_TB, self.L))
      ...
      tStart = time()
      data[:,8] = np.array(map(self.N_TT_EE, self.L))
      ...
      tStart = time()
      data[:,9] = np.array(map(self.N_TT_EB, self.L))
      ...
      tStart = time()
      data[:,10] = np.array(map(self.N_TE_TB, self.L))
      ...
      tStart = time()
      data[:,11] = np.array(map(self.N_TE_EE, self.L))
      ...
      tStart = time()
      data[:,12] = np.array(map(self.N_TE_EB, self.L))
      ...
      tStart = time()
      data[:,13] = np.array(map(self.N_TB_EE, self.L))
      ...
      tStart = time()
      data[:,14] = np.array(map(self.N_TB_EB, self.L))
      ...
      tStart = time()
      data[:,15] = np.array(map(self.N_EE_EB, self.L))
